$(document).ready(function(){
    ...
    $(window).scroll(function (event) {
        ...
        var percentage = scroll / bodyh * 100;
        console.log("Scroll height:" + scroll);
        console.log("Page Height:" + bodyh);
        console.log("Percentage:" + percentage);

        if(percentage > 42){
            $('.merch').slideDown(1000);
            $('.shirt').slideDown(1000);
        } 
        if(percentage < 42){
            $('.merch').slideUp();
            $('.shirt').slideUp();
        ...
        if(percentage > 63.5){
            $('.about_cast').fadeIn(1500);
        }

        if(percentage < 63.5){
            $('.about_cast').fadeOut(750);
        }
    });;
    ...
    var david = "David likes BMX, and BMX related accessories."
    ...
    $(".circle1").click(function () {
        ...
        if (window.innerHeight > window.innerWidth) {
            $(".circle").css("margin-top","0.5em");
        } else {
            $(".circle").css("margin-top", "0em");
        }
        $(this).addClass('bubble');
        $(".about_cast_header").html("BILLY");
        $(".circle2").hide();
        $(".circle3").hide();
        $(".circle4").hide();
        $(".cast_info").show();
    ...
    $(".circle3").click(function () {
        ...
        $(this).addClass('bubble');
        $(".about_cast_header").html("JENNELL");
        $(".circle2").hide();
        $(".circle1").hide();
        $(".circle4").hide();
        $(".cast_info").show();
